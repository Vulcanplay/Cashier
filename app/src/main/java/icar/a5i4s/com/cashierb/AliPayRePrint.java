...
public class AliPayRePrint extends AppCompatActivity implements AdapterView.OnItemClickListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setTitle(getString(R.string.ali_re_print));
        setContentView(R.layout.activity_alipay_re_print);
        webServicesTool = new WebServicesTool(getApplicationContext());
        message = (TextView) findViewById(R.id.message);
        weChatListView = (ListView) findViewById(R.id.reprint_list);
        ...
        dialog = new MaterialDialog.Builder(this)
                ...
                .cancelable(false)
                .show();
        webServicesTool.Connect("queryPosAlipayPayResult.do")
                ...
                if (data.size() == 0){
                    ...
                    for (int i = 0; i < data.size(); i++){
                        ...
                        lwx.add(new WXTicket(
                                ...
                                wt.get("biz_order_id") == null ? "无" : wt.get("biz_order_id").toString()));
                    }
